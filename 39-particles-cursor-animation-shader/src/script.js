...
displacement.context.fillStyle = 'white'
...
const numberOfParticles = particlesGeometry.attributes.position.count
const intensitiesArray = new Float32Array(numberOfParticles)
const anglesArray = new Float32Array(numberOfParticles)
...
// Update 2d canvas fill after first frame
